...
class AuthorPage(QWidget):
    def __init__(self, app):
        ...
        header.addWidget(self.image_label, 0, Qt.AlignTop)
...
class AlbumPage(QWidget):
    def __init__(self, app):
        ...
        header.addWidget(self.cover_label, 0, Qt.AlignTop)
...
class TrackPage(QWidget):
    def __init__(self, app):
        ...
        self.album_button.setCursor(Qt.PointingHandCursor)
        ...
        right.addWidget(self.play_button, 0, Qt.AlignLeft)
        ...
        self.author_image_label.setAlignment(Qt.AlignCenter)
        self.author_image_label.setStyleSheet("border: 1px solid #d0d0d0; background: #fafafa;")
        top.addWidget(self.author_image_label, 0, Qt.AlignTop)
...
class App(QWidget):
    def __init__(self):
        ...
        nav_bar.addWidget(self.back_button, 0, Qt.AlignLeft)
    ...
    def _build_author_form(self):
        ...
        layout.addWidget(self.btn_add_author, 0, Qt.AlignLeft)
    ...
    def _build_album_form(self):
        ...
        layout.addWidget(self.btn_add_album, 0, Qt.AlignLeft)
    ...
    def _build_song_form(self):
        ...
        layout.addWidget(self.btn_add_song, 0, Qt.AlignLeft)
